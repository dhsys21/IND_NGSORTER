...
void __fastcall TBaseForm::ChangeLanguage()
{
	...
	// RESET LABELS: keep the agreed names after startup/language refresh as well.
	// Only captions/layout changed; work recovery and tray-sequence reset stay separate.
	MainForm->AdvSmoothToggleButton_InitWork->Caption = "RESET WORK";
	MainForm->btnTrayStepInit->Caption = "INIT SEQ";
